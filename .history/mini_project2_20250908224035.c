...
struct Contact modifier_contact(struct Contact contact){
    ...
    char new_mail[50];
    if (strcmp(nom_modifier, contact.nom) == 0) {
        ...
        strcpy(contact.numero_telephone, new_telephone);
        strcpy(contact.mail, new_mail);
...
int main() {
    ...
    struct Contact contact_add, contact_mod;
    int index = 0;
    ...
    while (true) {
        ...
        switch (choix) {
            ...
            case 2:
                // Modifier un contact
                contact_mod = modifier_contact(contact_mod);
