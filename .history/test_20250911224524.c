...
int calcule_nbr_joueurs(struct Joueur joueurs[], int nombre_joueurs){
    for (int i = 0; i < nombre_joueurs; ) {
...
int main() {
    ...
    int index = 0;
    bool check_1 = true, check_2 = true, check_3 = true, check_5 = true, check_6;
    int nombre_joueurs;
